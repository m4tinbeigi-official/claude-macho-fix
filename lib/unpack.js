...
// Instead of a hardcoded extension list, this unions the hardcoded safe
// defaults with every file that was ALREADY unpacked next to the original
// asar (Resources/app.asar.unpacked/...). This means any current or future
// native binary — including the Claude Code CLI helper, whatever it's
// named — survives repacking as a real file instead of getting swallowed
// into the archive, which is what causes "Malformed Mach-o file" errors
// when Claude Desktop later tries to spawn it.
